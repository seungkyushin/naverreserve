...
<script src="../naverreserve/js/detail.js"></script>
<style>
.container_visual {
	height: 414px;
}
     		  ...
     		  <a href="./myreservation" class="btn_my"> <span class="viewReservation" title="${sessionScope.email}">${sessionScope.email}</span> </a>
				...
				<div class="section_info_tab">
					...
					<ul class="info_tab_lst">
						<li class="item active _detail"><a href="javascript:void(0)"
							class="anchor active" > <span>상세정보</span>
						</a></li>
						<li class="item _path"><a href="javascript:void(0)" class="anchor" > <span>오시는길</span>
						</a></li>
					</ul>
...
<script type="text/template" id="listItem_review">
<li class="list_item">
<div>
